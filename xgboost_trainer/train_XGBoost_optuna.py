...
def train_xgb(data, params, param_comb=1, folds=5):
    ...
    random_search.fit(X_train, y_train, early_stopping_rounds=20, eval_metric="logloss",
...
class Tune():
    ...
    def __call__(self, trial):
        ...
        xgb_model.fit(self.X_train, self.y_train, early_stopping_rounds=50, eval_metric="logloss",
...
if __name__ == '__main__':
    ...
    model_study = optuna.create_study(direction='minimize', sampler=sampler)
